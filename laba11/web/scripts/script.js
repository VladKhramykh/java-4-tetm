...
function JsonPost() {
    ...
    if (req) {
        req.open("POST", "/laba11_war/GoSssJson", false);
...
function XmlPost() {
    //let req = new XMLHttpRequest();
    if (req) {
        req.open("POST", "/laba11_war/GoSssXml", false);
        req.onreadystatechange = function () {
            if (req.readyState === 4) {
                if (req.status === 200) {
...
function Post() {
    let req = new XMLHttpRequest();
    if (req) {
        req.open("POST", "/laba11_war/GoSssHeader", true);
        req.onreadystatechange = function () {
            if (req.readyState === 4) {
                if (req.status === 200)
